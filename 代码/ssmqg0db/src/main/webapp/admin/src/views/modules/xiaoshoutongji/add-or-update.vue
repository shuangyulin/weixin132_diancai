<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="菜品编号" prop="caipinbianhao">
          <el-select  @change="caipinbianhaoChange" v-model="ruleForm.caipinbianhao" placeholder="请选择菜品编号">
            <el-option
                v-for="(item,index) in caipinbianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图片" prop="tupian">
          <el-input v-model="ruleForm.tupian" 
              placeholder="图片" clearable  :readonly="ro.tupian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图片" prop="tupian">
              <el-input v-model="ruleForm.tupian" 
                placeholder="图片" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总利润" prop="zonglirun">
          <el-input v-model="ruleForm.zonglirun" 
              placeholder="总利润" clearable  :readonly="ro.zonglirun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总利润" prop="zonglirun">
              <el-input v-model="ruleForm.zonglirun" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="统计时间" prop="tongjishijian">
          <el-select v-model="ruleForm.tongjishijian" placeholder="请选择统计时间">
            <el-option
                v-for="(item,index) in tongjishijianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="统计时间" prop="tongjishijian">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/caipinxinxi/caipinbianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.caipinbianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    caipinbianhaoChange () {
      this.$http({
        url: `follow/caipinxinxi/caipinbianhao?columnValue=`+ this.ruleForm.caipinbianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.caipinmingcheng){
                this.ruleForm.caipinmingcheng = data.data.caipinmingcheng
              }
              if(data.data.tupian){
                this.ruleForm.tupian = data.data.tupian
              }
              if(data.data.caixi){
                this.ruleForm.caixi = data.data.caixi
              }
        } else {
          this.$message.error(data.msg);
        }
