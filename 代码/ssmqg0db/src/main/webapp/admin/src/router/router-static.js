...
import center from '@/views/center'
    ...
    import tuikuanxinxi from '@/views/modules/tuikuanxinxi/list'
    import zhuohao from '@/views/modules/zhuohao/list'
    import caipinpinglun from '@/views/modules/caipinpinglun/list'
