 ...
 */
@TableName("tuikuanxinxi")
public class TuikuanxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public TuikuanxinxiEntity() {
		
	}
	
	public TuikuanxinxiEntity(T t) {
		try {
	 ...
	 * 设置：退款进度
	 */
	public void setTuikuanjindu(String tuikuanjindu) {
		this.tuikuanjindu = tuikuanjindu;
	}
	/**
	 * 获取：退款进度
	 */
	public String getTuikuanjindu() {
		return tuikuanjindu;
	}
	/**
	 * 设置：账号
